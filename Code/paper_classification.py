# -*- coding: utf-8 -*-
"""Paper_Classification.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/180gUtzQIuUnsHG1Pocj-Q77paeUyM-7o

# Pytorch script for paper classification
"""


#!pip install torchvision==0.8.1 pytorch-lightning==1.0.8 torchtext==0.8.0 transformers==4.4.1 nltk==3.3> /dev/null

# Commented out IPython magic to ensure Python compatibility.
# %cd "/content/drive/MyDrive/IDP/Code"
...
labels,data = create_labels_year(data)
...
bert = Bert(hparams)
classifier = Year_Classifier(hparams, bert, train_data, val_data, test_data)
